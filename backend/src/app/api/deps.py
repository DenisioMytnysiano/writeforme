...
def get_authorized_user(access_token: str = Depends(jwtTokenBearer), token_service: TokenServiceProtocol = Depends(TokenService), user_service: UserServiceProtocol = Depends(UserService)) -> User:
